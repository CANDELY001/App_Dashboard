 ...
 * @author HP
 */
public class BlankPlotChartAnimation extends JComponent {

    public BlankPlotChartRenderAnimation getBlankPlotChatRenderAnimation() {
        return BlankPlotChatRenderAnimation;
    }

    public void setBlankPlotChatRenderAnimation (BlankPlotChartRenderAnimation blankPlotChatRender) {
        this.BlankPlotChatRenderAnimation = blankPlotChatRender;
    }
    ...
    private BlankPlotChartRenderAnimation BlankPlotChatRenderAnimation;

    public BlankPlotChartAnimation() {
    ...
    private void renderSeries(Graphics2D g2) {
        if (BlankPlotChatRenderAnimation != null) {
            Insets insets = getInsets();
            double textWidth = getMaxValuesTextWidth(g2);
            double textHeight = getLabelTextHeight(g2);
            double spaceText = 5;
            ...
            double locationX = insets.left + textWidth + spaceText;
            for (int i = 0; i < labelCount; i++) {
                BlankPlotChatRenderAnimation.renderSeries(this, g2, getRectangle(i, height, space, locationX, insets.top), i);
            }
        }
    }
    ...
    private String getChartText(int index) {
        if (BlankPlotChatRenderAnimation != null) {
            return BlankPlotChatRenderAnimation.getLabelText(index);
        } else {
            return "Label";
        }
    }
